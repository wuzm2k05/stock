...
if __name__ == '__main__':
    ...
    #    print(order["id"],order["status"],order["symbol"])
    ...
    #order_id = "wuzmhk000003"
    #order_response = client.place_order(order_id,SecurityType.STK,"06862","",OrderSide.BUY,Currency.HKD,1000,13.00)
    #print(order_response.result_code)
    #print(order_response.data["status"]) #must have this attrbute and must be REPORTED
    #print(order_response)
